...
makePointsQuest = function(datawd = "e:/brent/nwos/input data/")
{
  ...
  source('functions/readPoints.R')
  points = readPoints(datawd = datawd)
  library(stringr)
  ...
  quest_11 = read.csv(paste(datawd, 'delete me/nwos2011.csv', sep = ''), stringsAsFactors = F)
  ...
  return(list(quest_11, quest_06, nonsampled_11, nonsampled_06, points_11, points_06, states_reference, areaNew))
}
